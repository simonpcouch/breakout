...
# Override method: _install
    ...
    def _install(self, target, ctm):
        ...
        if self.isFilled():
            style = tkinter.PIESLICE
        self.tkid = tkc.create_arc(x, y, x + self.width, y + self.height,
...
# Override method: getBounds
    ...
    def getBounds(self):
        ...
        x1 = min(self.x, self.x + self.dx)
        y1 = min(self.y, self.y + self.dy)
...
class GImage(GObject):
    ...
    def __init__(self, filename, x=0, y=0):
        ...
        size = Platform().createGImage(self, filename)
